            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                        ...
                        <Column field="code" header="Date" sortable body={codeBodyTemplate} headerStyle={{ width: '30%', minWidth: '10rem'}} className="bg-cyan-400 border-round-top"></Column>
                        <Column field="name" header="Msg" sortable body={nameBodyTemplate} headerStyle={{ width: '30%', minWidth: '10rem' }}className="bg-indigo-300 border-round-top" ></Column>
                        <Column field="price" header="ID_Utilisation" body={priceBodyTemplate} sortable headerStyle={{ width: '30%', minWidth: '8rem' }}className="bg-pink-200 border-round-top" ></Column>
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <InputText id="Msg" value={product.name} onChange={(e) => onInputChange(e, 'name')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.name })} />
                            {submitted && !product.name && <small className="p-invalid">Name is required.</small>}
                        </div>
                        <div className="field">
                            <label htmlFor="IDUtilisation">ID_Utilisation</label>
                            <InputText id="IDUtilisation" value={product.name} onChange={(e) => onInputChange(e, 'name')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.name })} />
                            {submitted && !product.name && <small className="p-invalid">Name is required.</small>}
                        </div>
